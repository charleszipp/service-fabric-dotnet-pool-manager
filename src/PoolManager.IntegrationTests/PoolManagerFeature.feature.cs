...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("pool start creates service instances with provided configuration", null, new string[] {
                        "ignore"});
#line 4
