...
namespace PoolManager.Partitions
{
    ...
    internal class Partitions : Actor, IPartitions, IRemindable
    {
        ...
        public Partitions(ActorService actorService, ActorId actorId, TelemetryClient telemetryClient, IInstanceProxy instances)
