...
namespace PoolManager.Core
{
    ...
    {
        Task CreateStatefulServiceAsync(Guid instanceId, string serviceTypeUri, PartitionSchemeDescription partitionSchemeDescription, int minReplicas = 1, int targetReplicas = 3, bool hasPersistedState = true);
        ...
        Task CreateStatelessServiceAsync(Guid instanceId, string serviceTypeUri, PartitionSchemeDescription partitionSchemeDescription, int instanceCount = 1, byte[] initializationData = null);
